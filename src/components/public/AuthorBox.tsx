    ...
    <div className="bg-muted/30 border border-border/50 rounded-xl p-6">
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-xs text-muted-foreground uppercase tracking-wider mb-1 font-medium">Escrito por</p>
          <h3 className="font-heading font-semibold text-foreground text-lg leading-tight">{name}</h3>
          {bio && <p className="text-muted-foreground text-sm mt-2 leading-relaxed">{bio}</p>}
          {linkedinUrl && (
